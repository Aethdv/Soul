    ...
    pub fn into_scheduler(self) -> Box<dyn LrScheduler> {
        match self {
            ...
            Self::StepDecay {
                ...
                gamma,
                step_epochs,
            } => Box::new(schedule::StepDecay::new(start, gamma, step_epochs)),
            Self::Cosine {
                base,
                min,
                warmup_ratio,
                ...
                schedule::CosineAnnealing::new(base, min)
                    .warmup_ratio(warmup_ratio)
                    .restarts(restarts),
            ),
            Self::WarmupStableDecay {
                base,
                min,
                warmup_ratio,
                stable_ratio,
    ...
    pub fn into_scheduler(self) -> Box<dyn WdlScheduler> {
        match self {
            ...
            Self::StableDecay {
                ...
                stable_ratio,
            } => Box::new(schedule::StableDecayWdl::new(start, end, stable_ratio)),
        }
    }
}
    ...
    fn default() -> Self {
        Self {
            evaltune:   EvalTuneConfig {
                lr_schedule:  LrScheduleConfig::Cosine {
                    base:         0.1,
                    min:          0.0001,
                    warmup_ratio: 0.1,
                    restarts:     1,
