...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  61,  -42),  S(  66,   10),  S(  90,   16),  S(  60,   27),
        S( -11,    6),  S(  43,   -2),  S(  60,   -3),  S(  40,    3),
        S(   8,   -4),  S(   2,   -9),  S(  44,  -19),  S(  69,  -25),
        S( -24,   -6),  S( -27,   -5),  S(  -4,   -7),  S(   2,  -12),
        S( -54,   -1),  S( -51,   -4),  S( -70,    7),  S( -49,    6),
        S( -55,    8),  S(-100,    7),  S( -47,   18),  S( -55,   24),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-210,   14),  S(-158,  -17),  S(-122,    4),  S( -82,  -15),
        S( -64,   -4),  S(  28,  -32),  S(  84,  -32),  S(  96,   -7),
        S(  17,  -34),  S(  77,    9),  S( 123,    2),  S( 134,   -3),
        S(  13,   -2),  S(  60,   11),  S(  82,   14),  S( 104,   25),
        S(  28,   -8),  S(  47,    5),  S(  54,   26),  S(  72,   26),
        S( -21,   -9),  S(  -9,    8),  S(  19,   25),  S(  38,   29),
        S( -56,  -30),  S( -56,   13),  S( -18,   14),  S(  11,   17),
        S(-132,  -48),  S( -73,  -14),  S( -52,    6),  S( -47,   15),
    ],

    BISHOP = [
        S( -53,   10),  S(-130,   18),  S(-135,   14),  S(-131,   23),
        S(  -8,   -6),  S(  48,   -4),  S(  16,   10),  S(   1,    8),
        S(  40,   -7),  S(  55,   11),  S(  78,    7),  S(  73,   10),
        S(   6,    4),  S(  50,   10),  S(  43,   15),  S(  93,   18),
        S(   8,  -14),  S(  23,   12),  S(  54,   13),  S(  43,   26),
        S(   3,   -7),  S(  21,    5),  S(  19,   15),  S(  32,   16),
        S(   4,  -23),  S(  -2,   -8),  S(   3,    0),  S(  13,    6),
        S(-166, -188),  S( -44,   -7),  S( -11,    7),  S( -47,    6),
    ],

    ROOK = [
        S( -37,   39),  S(   0,   12),  S(  14,    8),  S(  10,   13),
        S( -17,   13),  S(  34,   -3),  S(  44,   -8),  S(  44,   -7),
        S(   6,    4),  S(  46,  -16),  S(  85,  -25),  S(  74,  -26),
        S(  -6,    1),  S(  18,   -4),  S(  21,   -9),  S(  46,  -16),
        S( -27,   17),  S( -19,   16),  S( -14,   16),  S( -15,   13),
        S( -27,   11),  S( -21,    8),  S( -33,   16),  S( -19,    8),
        S( -80,   27),  S( -60,    6),  S( -23,   -9),  S( -13,  -11),
        S( -34,   -3),  S( -11,  -13),  S(   7,  -29),  S(  12,  -33),
    ],

    QUEEN = [
        S( -14,  -19),  S( -57,   12),  S( -39,   19),  S( -44,   30),
        S( -23,    7),  S( -32,   34),  S( -65,   80),  S( -77,   96),
        S(   5,   11),  S(   3,   26),  S(   9,   50),  S( -20,   71),
        S(   2,    7),  S(   1,   43),  S( -25,   60),  S( -22,   80),
        S(  23,   -7),  S(  17,   11),  S(   2,   38),  S(  -6,   50),
        S(  31,  -54),  S(  27,  -32),  S(  23,   -7),  S(  40,  -15),
        S(  13,  -50),  S(  23,  -71),  S(  56,  -74),  S(  71,  -86),
        S( -31,  -32),  S(  14,  -82),  S(  39,  -88),  S(  46,  -96),
    ],

    KING = [
        S(-145, -121),  S( 111, -127),  S(  78,  -74),  S( 157,  -66),
        S(  -6,  -68),  S(  65,  -12),  S(  76,  -28),  S(  39,    2),
        S(  43,  -15),  S( 103,    4),  S(  24,   32),  S( -53,   28),
        S(  26,  -25),  S(  30,   14),  S( -23,   44),  S( -99,   56),
        S( -45,  -11),  S( -62,   43),  S( -72,   60),  S( -71,   66),
        S( -87,   12),  S( -79,   43),  S( -99,   59),  S(-101,   64),
        S(  37,   -6),  S(  -3,   22),  S( -32,   36),  S( -51,   41),
        S(  70,  -52),  S(  94,  -28),  S(  51,   -3),  S(  14,    0),
    ],
}
...
define_simd_params! {
    mobility_open {
        mg = [V(7), V(-9), V(25), V(3)], // [mobility, battery, threats, xray threats]
        eg = [V(-9), V(-7), V(6), V(-10)],
    },
    mobility_closed {
        mg = [V(4), V(4), V(-34), V(-8)],
        eg = [V(45), V(27), V(50), V(-23)],
    },
}
...
define_weight_params! {
    ...
    king_safety = [V(52), V(12), V(9)], // [Pawn Shield, Ortho Exp, Diag Exp]
    attacker    = [CV(0), V(94), V(271), V(311), V(295), V(330)], // [0, 1, 2, 3, 4, 5] attackers × weak
    xray        = [V(26)], // [Ortho King]
    king_danger = [V(0)]; // pressure curvature, over DANGER_SCALE; floored at 0, the data pulls under

    tempo             = [V(21), V(-1)], // [MG, EG], side-to-move initiative
    bishop_pair       = [V(76), V(22)], // [MG, EG]
    rook_open         = [V(31), V(-12)], // [MG, EG]
    minor_behind_pawn = [V(22), V(30)]; // [MG, EG]

    doubled_pawn       = [V(-33), V(-46)], // [MG, EG]
    isolated_pawn      = [V(-16), V(-8)], // [MG, EG]
    backward_pawn      = [V(-15), V(-15)], // [MG, EG]
    phalanx_mg         = [V(7), V(23), V(36), V(52), V(292), V(140)], // by relative rank 2-7
    phalanx_eg         = [V(4), V(2), V(6), V(39), V(-11), V(394)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(41), V(31), V(29), V(56), V(266)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    defended_pawn_eg   = [CV(0), V(6), V(5), V(10), V(33), V(-18)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    passed_pawn_mg     = [V(-25), V(-30), V(-34), V(-22), V(51), V(109)], // by relative rank 2-7
    passed_pawn_eg     = [V(-26), V(-5), V(24), V(47), V(56), V(76)], // by relative rank 2-7
    enemy_king_dist_mg = [V(-127), V(26), V(23), V(16), V(10), V(1)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-28), V(-3), V(18), V(29), V(39), V(49)]; // enemy king→passer dist, 7 clamps to 6
}
