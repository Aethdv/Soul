...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  66,  109),  S( 101,   68),  S(  85,   99),  S( 103,   72),
        S(   2,   17),  S(  13,   17),  S(  68,  -32),  S(  50,  -58),
        S( -28,   -5),  S( -16,  -15),  S(  -4,  -33),  S(  13,  -49),
        S( -42,  -17),  S( -37,  -13),  S( -30,  -22),  S(  -9,  -28),
        S( -50,  -21),  S( -44,  -19),  S( -45,  -14),  S( -37,  -14),
        S( -49,  -14),  S( -35,  -13),  S( -37,   -7),  S( -43,   -7),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-168, -131),  S(-107,  -41),  S( -79,  -18),  S( -40,  -11),
        S(   9,  -36),  S(  19,   -3),  S(  68,   -4),  S(  45,    3),
        S(  22,  -19),  S(  50,    0),  S(  79,   19),  S( 102,   21),
        S(  26,   -5),  S(  18,   25),  S(  71,   37),  S(  61,   50),
        S(  -5,    5),  S(  35,   16),  S(  29,   39),  S(  38,   53),
        S( -30,   -9),  S(   8,   12),  S(  12,   22),  S(  28,   43),
        S( -27,  -12),  S( -38,   -2),  S(  -9,   13),  S(   2,   20),
        S( -89,  -34),  S( -54,  -43),  S( -36,  -14),  S( -31,    5),
    ],

    BISHOP = [
        S( -58,   -1),  S( -67,   10),  S( -85,    3),  S(-135,   21),
        S(   1,  -16),  S(  23,    6),  S(  16,    4),  S(  11,    2),
        S(  25,   -1),  S(  29,    3),  S(  35,   14),  S(  45,    5),
        S(   0,   -5),  S(  13,   10),  S(  34,   13),  S(  46,   25),
        S(   3,  -17),  S(   5,    9),  S(  11,   19),  S(  29,   22),
        S(  -1,  -12),  S(  16,   -2),  S(  11,   16),  S(   9,   18),
        S(   0,  -27),  S(  14,  -23),  S(  25,  -22),  S(  -1,    5),
        S( -13,  -42),  S(   9,   -9),  S( -25,  -24),  S( -17,   -4),
    ],

    ROOK = [
        S( -16,   13),  S( -53,   27),  S( -44,   32),  S( -51,   24),
        S(   4,    5),  S(   0,   15),  S(  26,   12),  S(  30,    4),
        S(   9,    2),  S(  51,   -5),  S(  43,   -7),  S(  43,  -13),
        S(   4,    5),  S(  20,   -1),  S(  23,    2),  S(  21,   -5),
        S( -22,    6),  S(  -4,    3),  S(  -9,    4),  S(   4,    2),
        S( -15,   -9),  S(  10,  -21),  S(  -3,  -11),  S(  -2,   -4),
        S( -33,   -6),  S(  -7,  -13),  S(  -4,  -13),  S(  -4,  -14),
        S( -11,   -5),  S(  -4,  -10),  S( -16,   -4),  S(   5,  -19),
    ],

    QUEEN = [
        S( -34,  -70),  S( -17,  -61),  S( -35,  -10),  S( -25,   -6),
        S(  26,  -24),  S( -32,   21),  S( -15,   36),  S( -45,   69),
        S(  31,   -6),  S(  40,  -15),  S(   5,   46),  S(   4,   53),
        S(  22,    7),  S(  -3,   52),  S(   2,   36),  S( -17,   71),
        S(   4,   15),  S(  12,   28),  S(  -8,   43),  S(  -5,   54),
        S(  11,  -26),  S(  12,    4),  S(   8,   23),  S(   2,   25),
        S(  22,  -67),  S(  17,  -61),  S(  25,  -48),  S(  18,  -11),
        S( -14,  -48),  S( -12,  -45),  S( -10,  -50),  S(   6,  -32),
    ],

    KING = [
        S(  35, -127),  S(  -8,  -36),  S(  15,  -28),  S( -26,  -15),
        S( -80,    6),  S(  15,   46),  S( -10,   52),  S(  52,   30),
        S( -71,    7),  S(  40,   49),  S(  25,   60),  S(  10,   64),
        S( -88,   -4),  S( -20,   39),  S( -29,   61),  S( -65,   72),
        S(-113,  -16),  S( -38,   18),  S( -37,   43),  S( -84,   66),
        S( -36,  -33),  S(  24,  -10),  S(  -7,   19),  S( -11,   33),
        S(  71,  -65),  S(  71,  -33),  S(  38,   -7),  S(  16,    7),
        S(  77, -124),  S(  91,  -80),  S(  62,  -48),  S(  65,  -57),
    ],
}
...
define_simd_params! {
    ...
    mobility_closed {
        mg = [V(0), V(8), V(-17), V(-5)],
        eg = [V(27), V(12), V(41), V(-31)],
    },
}

define_weight_params! {
    phase              = [CV(0), CV(1), CV(1), CV(2), CV(4), CV(0)], // [P, N, B, R, Q, K]
    attacker           = [CV(0), V(180), V(280), V(473), V(557), V(572)], // [0, 1, 2, 3, 4, 5] attackers × weak
    ...
    passed_pawn_mg     = [V(-9), V(-23), V(-25), V(-3), V(-6), V(-5)], // by relative rank 1-6
    passed_pawn_eg     = [V(-54), V(-30), V(18), V(71), V(167), V(146)], // by relative rank 1-6
    enemy_king_dist_mg = [V(-109), V(24), V(10), V(6), V(4), V(-2)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-43), V(7), V(48), V(61), V(73), V(81)], // enemy king→passer dist, 7 clamps to 6
    doubled_pawn       = [V(3), V(-45)], // [MG, EG]
    isolated_pawn      = [V(-9), V(-12)], // [MG, EG]
    phalanx_mg         = [V(6), V(16), V(28), V(62), V(109), V(-181)], // by relative rank 2-7
    phalanx_eg         = [V(-7), V(1), V(24), V(88), V(211), V(371)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(32), V(21), V(19), V(29), V(163)], // by relative rank 2-7 (rank 2 unreachable)
