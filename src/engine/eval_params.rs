...
define_psqt_params! {
    PAWN = [
        ...
        S(  76,   -1),  S(  17,   28),  S(  20,   42),  S(  83,   17),
        S(  -6,   -4),  S(  14,   -2),  S(  38,   -6),  S(  58,  -22),
        S( -20,    1),  S(  15,   -9),  S(  28,  -17),  S(  56,  -24),
        S( -41,    1),  S(  -9,   -4),  S(  -6,   -5),  S(  13,  -15),
        S( -49,    0),  S( -23,   -3),  S( -37,    3),  S( -51,    3),
        S( -59,   -1),  S( -20,    7),  S( -17,    4),  S( -65,   10),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-284,  -24),  S(  21,  -39),  S( -93,   17),  S( -13,   16),
        S(  -1,  -23),  S( -24,    1),  S(  65,  -21),  S(  92,    2),
        S(  -3,  -21),  S(  88,   -1),  S(  94,    5),  S( 132,    2),
        S(  59,  -31),  S(  30,   22),  S(  67,   18),  S(  77,   25),
        S(   7,   -2),  S(  30,    1),  S(  40,   22),  S(  41,   36),
        S( -54,   -2),  S(   3,    3),  S(   7,   22),  S(  28,   27),
        S( -53,  -32),  S( -42,   18),  S( -25,    6),  S( -17,   25),
        S(-107,  -46),  S( -97,  -12),  S( -55,   -5),  S( -33,    9),
    ],

    BISHOP = [
        S(-107,   30),  S( -41,   11),  S(-143,   24),  S(-133,   30),
        S( -21,   -4),  S( -10,   18),  S(   2,   12),  S(  -6,   11),
        S(  24,  -12),  S(  45,    2),  S(  43,    9),  S(  80,   -7),
        S(   0,  -11),  S(  32,    6),  S(  44,   -4),  S(  71,   -7),
        S(   3,  -12),  S(  17,   -6),  S(  33,    6),  S(  48,    0),
        S(  -5,   -8),  S(  25,   -4),  S(  19,   -8),  S(  21,    3),
        S(  11,  -22),  S(  14,  -20),  S(   7,  -10),  S(  -9,    2),
        S( -17,  -16),  S(  22,  -22),  S( -41,   -4),  S( -35,   -4),
    ],

    ROOK = [
        S(   7,   12),  S(  -8,   19),  S(   0,   20),  S(  14,   12),
        S(   9,    4),  S(   5,    7),  S(  63,  -16),  S(  87,  -21),
        S(   8,    1),  S(  56,  -11),  S(  63,  -15),  S(  94,  -29),
        S(  -6,    9),  S(  24,    0),  S(  34,   -2),  S(  41,   -5),
        S( -34,   12),  S( -17,    6),  S(  -1,    1),  S(  14,   -2),
        S( -66,    8),  S( -33,    4),  S( -30,    6),  S( -10,   -3),
        S( -89,   18),  S( -59,    0),  S( -28,  -10),  S( -19,  -14),
        S( -56,   11),  S( -32,    1),  S( -22,  -11),  S(   6,  -24),
    ],

    QUEEN = [
        S( -27,   18),  S( -31,   27),  S( -26,   32),  S( -24,   37),
        S(  -3,    3),  S( -94,   81),  S( -33,   50),  S( -44,   66),
        S(   7,   20),  S(  12,   10),  S( -13,   61),  S(   0,   39),
        S(  34,  -30),  S( -15,   51),  S(  -4,   43),  S( -15,   52),
        S(   7,   10),  S(   7,    7),  S(  -1,   26),  S(  -2,   20),
        S(   8,  -34),  S(  31,  -36),  S(  17,  -12),  S(  23,  -13),
        S(  32,  -68),  S(  28,  -86),  S(  44,  -83),  S(  29,  -49),
        S(  20,  -74),  S(  15,  -79),  S(   0,  -61),  S(  -3,  -33),
    ],

    KING = [
        S(-208, -103),  S(  -8,  -20),  S( -12,  -29),  S( 132,   19),
        S(-105,  -56),  S(  29,   11),  S( 137,   28),  S(  96,   39),
        S(  86,  -21),  S(  53,   10),  S(  -4,   31),  S( -22,   22),
        S(  50,  -27),  S(  62,   10),  S(  -2,   20),  S( -43,   28),
        S( -24,   -9),  S( -42,   26),  S( -34,   37),  S( -25,   45),
        S( -48,   -1),  S( -55,   23),  S( -71,   38),  S( -69,   43),
        S(  37,  -28),  S(  14,   -6),  S( -37,   19),  S( -55,   22),
        S(  67,  -78),  S(  80,  -42),  S(  19,  -14),  S(  -6,  -20),
    ],
}
...
define_simd_params! {
    mobility_open {
        mg = [V(3), V(-5), V(18), V(-3)], // [mobility, battery, threats, xray threats]
        eg = [V(-6), V(-7), V(12), V(-5)],
    },
    mobility_closed {
        mg = [V(3), V(1), V(-35), V(1)],
        eg = [V(30), V(20), V(24), V(-36)],
    },
}
...
define_weight_params! {
    ...
    king_safety = [V(36), V(7), V(7)], // [Pawn Shield, Ortho Exp, Diag Exp]
    attacker    = [CV(0), V(111), V(172), V(205), V(186), V(238)], // [0, 1, 2, 3, 4, 5] attackers × weak
    xray        = [V(14)], // [Ortho King]
    king_danger = [V(0)]; // pressure curvature, over DANGER_SCALE; floored at 0, the data pulls under

    tempo             = [V(16), V(-1)], // [MG, EG], side-to-move initiative
    bishop_pair       = [V(63), V(56)], // [MG, EG]
    rook_open         = [V(38), V(-8)], // [MG, EG]
    minor_behind_pawn = [V(21), V(26)]; // [MG, EG]

    doubled_pawn       = [V(-26), V(-26)], // [MG, EG]
    isolated_pawn      = [V(-13), V(-10)], // [MG, EG]
    backward_pawn      = [V(-11), V(-11)], // [MG, EG]
    phalanx_mg         = [V(19), V(30), V(44), V(81), V(341), V(-39)], // by relative rank 2-7
    phalanx_eg         = [V(13), V(-1), V(6), V(41), V(21), V(555)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(52), V(34), V(46), V(77), V(306)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    defended_pawn_eg   = [CV(0), V(10), V(4), V(11), V(29), V(-7)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    passed_pawn_mg     = [V(-62), V(-48), V(-25), V(2), V(62), V(115)], // by relative rank 2-7
    passed_pawn_eg     = [V(-5), V(0), V(20), V(45), V(76), V(88)], // by relative rank 2-7
    enemy_king_dist_mg = [V(-165), V(-6), V(0), V(11), V(17), V(27)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-11), V(6), V(23), V(30), V(35), V(41)]; // enemy king→passer dist, 7 clamps to 6
}
