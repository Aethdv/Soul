...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S( 158,  122),  S( 199,  113),  S( 201,  107),  S( 241,   75),  
        S(  44,   91),  S(  85,   84),  S(  95,   59),  S( 106,   61),  
        S(   2,   46),  S(  33,   37),  S(  30,   16),  S(  67,    9),  
        S(  -2,   28),  S(  33,   26),  S(  33,    5),  S(  52,    9),  
        S(   8,   19),  S(  46,   12),  S(  21,    7),  S(  32,    7),  
        S(  -1,   25),  S(  37,   22),  S(  24,   15),  S(   0,   28),  
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  
    ],
    KNIGHT = [
        S(  58,  -92),  S( -31,   -6),  S( 172,  -38),  S( 275,  -62),  
        S( 234,  -58),  S( 217,  -25),  S( 274,  -34),  S( 284,  -40),  
        S( 196,  -34),  S( 262,  -30),  S( 282,  -21),  S( 339,  -37),  
        S( 236,  -41),  S( 237,  -15),  S( 282,  -13),  S( 260,    9),  
        S( 204,  -46),  S( 232,  -23),  S( 243,  -12),  S( 255,   -6),  
        S( 174,  -51),  S( 219,  -34),  S( 226,  -36),  S( 245,  -18),  
        S( 183,  -64),  S( 188,  -39),  S( 212,  -45),  S( 220,  -33),  
        S(  95,  -70),  S( 189,  -79),  S( 177,  -50),  S( 198,  -57),  
    ],
    BISHOP = [
        S( 206,   -8),  S( 241,   -8),  S( 208,  -10),  S( 229,  -13),  
        S( 235,  -14),  S( 255,    5),  S( 274,   -4),  S( 265,   -7),  
        S( 279,   -8),  S( 281,    6),  S( 299,    5),  S( 310,  -14),  
        S( 267,   -7),  S( 267,    9),  S( 285,    1),  S( 317,   10),  
        S( 256,  -15),  S( 276,   -5),  S( 269,   12),  S( 299,    8),  
        S( 249,  -11),  S( 280,  -19),  S( 276,    7),  S( 272,   12),  
        S( 260,  -44),  S( 283,  -19),  S( 286,  -23),  S( 267,   -1),  
        S( 238,  -31),  S( 258,  -23),  S( 233,  -17),  S( 244,   -9),  
    ],
    ROOK = [
        S( 270,   -4),  S( 282,   -4),  S( 290,   -7),  S( 279,   -5),  
        S( 288,   -9),  S( 309,   -8),  S( 335,  -16),  S( 354,  -21),  
        S( 258,   -4),  S( 299,  -13),  S( 310,  -19),  S( 341,  -29),  
        S( 250,    1),  S( 261,   -8),  S( 275,   -6),  S( 312,  -21),  
        S( 212,   -5),  S( 236,   -8),  S( 238,   -2),  S( 280,  -13),  
        S( 213,   -7),  S( 242,  -21),  S( 242,  -13),  S( 250,  -15),  
        S( 199,  -17),  S( 237,  -33),  S( 241,  -26),  S( 241,  -23),  
        S( 241,  -19),  S( 239,  -25),  S( 241,  -24),  S( 266,  -37),  
    ],
    QUEEN = [
        S( 176,  268),  S( 163,  305),  S( 148,  303),  S( 201,  267),  
        S( 191,  273),  S( 149,  306),  S( 186,  286),  S( 178,  305),  
        S( 209,  254),  S( 216,  263),  S( 193,  292),  S( 226,  277),  
        S( 224,  229),  S( 188,  292),  S( 210,  269),  S( 198,  289),  
        S( 211,  255),  S( 222,  244),  S( 206,  272),  S( 212,  279),  
        S( 217,  200),  S( 234,  220),  S( 224,  238),  S( 217,  247),  
        S( 229,  156),  S( 238,  145),  S( 259,  129),  S( 238,  189),  
        S( 225,  133),  S( 219,  138),  S( 207,  154),  S( 239,  151),  
    ],
    KING = [
        S(  32, -156),  S( -28,  -57),  S(  21,  -35),  S( -48,  -21),  
        S( 131,  -84),  S(  96,   -4),  S(  79,    6),  S(  27,    6),  
        S(  26,  -30),  S(  11,   29),  S(  -5,   38),  S( -54,   44),  
        S(  -5,  -20),  S( -25,   32),  S( -16,   41),  S( -64,   55),  
        S( -83,  -13),  S( -61,   17),  S( -50,   35),  S( -43,   48),  
        S(-115,   -8),  S( -60,    0),  S( -70,   27),  S( -71,   42),  
        S( -40,  -38),  S( -39,  -13),  S( -75,   16),  S( -83,   23),  
        S( -36,  -88),  S( -11,  -48),  S( -66,  -16),  S( -50,  -26),  
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS    = [CV(0), V(83), V(162), V(200), V(139), V(109)], // [0, 1, 2, 3, 4, 5] attackers × weak
