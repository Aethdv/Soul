...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  22,   80),  S(  57,   39),  S(  41,   70),  S(  58,   44),
        S(  11,   23),  S(  21,   23),  S(  77,  -26),  S(  58,  -52),
        S( -19,    1),  S(  -7,   -9),  S(   5,  -27),  S(  21,  -42),
        S( -33,  -11),  S( -28,   -7),  S( -21,  -16),  S(   1,  -22),
        S( -41,  -14),  S( -35,  -13),  S( -36,   -8),  S( -29,   -7),
        S( -40,   -8),  S( -27,   -7),  S( -28,   -1),  S( -34,    0),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-169, -132),  S(-110,  -41),  S( -86,  -16),  S( -33,  -14),
        S(   8,  -36),  S(  18,   -3),  S(  67,   -4),  S(  44,    3),
        S(  21,  -19),  S(  50,    0),  S(  78,   19),  S( 101,   20),
        S(  26,   -6),  S(  18,   24),  S(  70,   36),  S(  60,   49),
        S(  -6,    4),  S(  35,   16),  S(  28,   39),  S(  38,   52),
    ...
    BISHOP = [
        S( -59,   -1),  S( -71,   11),  S( -85,    3),  S(-135,   21),
        S(   1,  -17),  S(  22,    6),  S(  15,    4),  S(  11,    2),
        S(  25,   -2),  S(  29,    3),  S(  34,   14),  S(  44,    5),
        S(  -1,   -5),  S(  13,   10),  S(  34,   13),  S(  46,   25),
        S(   3,  -17),  S(   4,    9),  S(  11,   19),  S(  28,   22),
        S(  -1,  -12),  S(  16,   -2),  S(  11,   16),  S(   9,   18),
        S(  -1,  -27),  S(  14,  -23),  S(  24,  -22),  S(  -1,    5),
        S( -13,  -42),  S(   9,   -9),  S( -25,  -23),  S( -17,   -4),
    ],

    ROOK = [
        S( -17,   12),  S( -54,   27),  S( -45,   32),  S( -52,   24),
        S(   4,    5),  S(  -1,   14),  S(  26,   12),  S(  29,    4),
        S(   9,    2),  S(  51,   -5),  S(  43,   -8),  S(  42,  -13),
        S(   4,    5),  S(  19,   -1),  S(  23,    2),  S(  20,   -5),
        S( -22,    6),  S(  -4,    3),  S(  -9,    4),  S(   4,    2),
        S( -15,   -9),  S(  10,  -21),  S(  -3,  -11),  S(  -2,   -5),
        S( -33,   -6),  S(  -7,  -14),  S(  -4,  -14),  S(  -4,  -14),
        S( -11,   -5),  S(  -5,  -10),  S( -16,   -4),  S(   5,  -20),
    ],

    QUEEN = [
        S( -34,  -71),  S( -17,  -61),  S( -35,   -9),  S( -26,   -6),
        S(  27,  -24),  S( -32,   21),  S( -15,   36),  S( -45,   69),
        S(  31,   -7),  S(  40,  -15),  S(   5,   46),  S(   4,   53),
        S(  22,    7),  S(  -2,   51),  S(   2,   36),  S( -17,   71),
        S(   4,   15),  S(  12,   28),  S(  -8,   43),  S(  -4,   53),
        S(  11,  -27),  S(  13,    4),  S(   8,   23),  S(   2,   25),
        S(  23,  -67),  S(  18,  -61),  S(  25,  -47),  S(  19,  -11),
        S( -13,  -48),  S( -12,  -45),  S( -10,  -50),  S(   6,  -31),
    ],

    KING = [
        S(  40, -131),  S(  -1,  -37),  S(  19,  -29),  S( -21,  -16),
        S( -73,    5),  S(  23,   44),  S(  -2,   51),  S(  58,   29),
        S( -65,    6),  S(  50,   48),  S(  33,   59),  S(  17,   63),
        S(-104,   -1),  S( -17,   39),  S( -32,   62),  S( -87,   76),
        S(-114,  -16),  S( -39,   19),  S( -38,   43),  S( -85,   67),
        S( -37,  -33),  S(  23,  -10),  S(  -9,   20),  S( -12,   33),
        S(  70,  -64),  S(  69,  -32),  S(  36,   -6),  S(  15,    7),
        S(  76, -124),  S(  89,  -80),  S(  61,  -48),  S(  64,  -57),
    ],
}
...
define_weight_params! {
    ...
    attacker           = [CV(0), V(178), V(282), V(471), V(556), V(571)], // [0, 1, 2, 3, 4, 5] attackers × weak
    ...
    passed_pawn_mg     = [V(-4), V(-18), V(-20), V(2), V(-1), V(53)], // by relative rank 1-6
    passed_pawn_eg     = [V(-68), V(-44), V(4), V(57), V(152), V(166)], // by relative rank 1-6
    enemy_king_dist_mg = [V(-114), V(19), V(5), V(1), V(-1), V(-7)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-29), V(22), V(62), V(75), V(87), V(95)], // enemy king→passer dist, 7 clamps to 6
    doubled_pawn       = [V(3), V(-45)], // [MG, EG]
    isolated_pawn      = [V(-9), V(-12)], // [MG, EG]
    phalanx_mg         = [V(6), V(16), V(27), V(62), V(111), V(-183)], // by relative rank 2-7
    phalanx_eg         = [V(-7), V(1), V(24), V(88), V(211), V(375)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(32), V(21), V(18), V(28), V(164)], // by relative rank 2-7 (rank 2 unreachable)
