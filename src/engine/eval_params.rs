...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S( 104,  187),  S( 133,  149),  S( 120,  180),  S( 131,  157),
        S(  18,   61),  S(  28,   60),  S(  82,   12),  S(  65,  -15),
        S( -14,   37),  S(  -1,   28),  S(  11,    9),  S(  27,   -6),
        S( -28,   26),  S( -23,   30),  S( -15,   21),  S(   6,   15),
        S( -36,   22),  S( -30,   24),  S( -30,   29),  S( -23,   29),
        S( -34,   29),  S( -21,   30),  S( -22,   36),  S( -28,   37),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-170,  -39),  S(-133,   55),  S( -97,   76),  S( -46,   79),
        S(   4,   57),  S(  15,   87),  S(  65,   85),  S(  41,   93),
        S(  14,   73),  S(  45,   94),  S(  75,  110),  S(  98,  109),
        S(  22,   86),  S(  15,  113),  S(  66,  127),  S(  55,  141),
        S( -10,   94),  S(  31,  107),  S(  24,  130),  S(  34,  144),
        S( -35,   81),  S(   4,  102),  S(   8,  112),  S(  23,  133),
        S( -32,   82),  S( -40,   87),  S( -13,  106),  S(  -2,  111),
        S( -92,   52),  S( -59,   50),  S( -40,   77),  S( -35,   98),
    ],

    BISHOP = [
        S( -48,   80),  S( -67,   95),  S( -72,   86),  S(-126,  106),
        S(   9,   68),  S(  32,   91),  S(  23,   88),  S(  16,   85),
        S(  34,   81),  S(  40,   85),  S(  43,   98),  S(  52,   90),
        S(   8,   79),  S(  22,   94),  S(  44,   97),  S(  54,  108),
        S(  12,   66),  S(  12,   93),  S(  20,  103),  S(  38,  105),
        S(  10,   71),  S(  24,   84),  S(  20,   99),  S(  18,  102),
        S(   9,   55),  S(  22,   62),  S(  32,   63),  S(   8,   90),
        S(  -3,   44),  S(  19,   73),  S( -16,   61),  S(  -8,   81),
    ],

    ROOK = [
        S(-111,  107),  S(-149,  123),  S(-140,  126),  S(-147,  119),
        S( -93,  101),  S( -99,  110),  S( -71,  107),  S( -68,  100),
        S( -87,   98),  S( -45,   91),  S( -55,   89),  S( -56,   84),
        S( -96,  102),  S( -77,   95),  S( -74,   97),  S( -79,   92),
        S(-118,  102),  S(-100,   98),  S(-106,  100),  S( -92,   96),
        S(-114,   90),  S( -88,   76),  S(-100,   85),  S( -98,   91),
        S(-130,   90),  S(-106,   82),  S(-101,   83),  S(-101,   82),
        S(-108,   92),  S(-102,   87),  S(-113,   91),  S( -92,   77),
    ],

    QUEEN = [
        S(-443,  345),  S(-428,  359),  S(-439,  404),  S(-438,  416),
        S(-383,  394),  S(-439,  434),  S(-424,  451),  S(-454,  484),
        S(-377,  407),  S(-372,  403),  S(-407,  466),  S(-405,  471),
        S(-388,  424),  S(-412,  468),  S(-408,  455),  S(-425,  486),
        S(-405,  434),  S(-396,  443),  S(-417,  461),  S(-415,  471),
        S(-400,  393),  S(-397,  422),  S(-401,  439),  S(-407,  441),
        S(-387,  350),  S(-390,  355),  S(-385,  371),  S(-390,  406),
        S(-425,  373),  S(-419,  367),  S(-420,  369),  S(-403,  385),
    ],

    KING = [
        S(  16, -140),  S( -33,  -43),  S( -25,  -33),  S( -87,  -17),
        S(-156,    8),  S( -11,   39),  S( -58,   50),  S(  32,   20),
        S(-170,   14),  S(  -3,   47),  S(  -1,   53),  S( -44,   63),
        S(-172,    1),  S( -76,   38),  S( -87,   61),  S(-137,   73),
        S(-176,  -17),  S( -96,   17),  S( -88,   41),  S(-137,   64),
        S( -93,  -35),  S( -33,  -10),  S( -66,   19),  S( -68,   32),
        S(  14,  -65),  S(  14,  -34),  S( -19,   -8),  S( -41,    6),
        S(  20, -124),  S(  33,  -81),  S(   4,  -48),  S(   7,  -58),
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS          = [CV(0), V(190), V(280), V(470), V(552), V(572)], // [0, 1, 2, 3, 4, 5] attackers × weak
    KING_SAFETY_WEIGHTS       = [V(23), V(11), V(9)], // [Pawn Shield, Ortho Exp, Diag Exp]
    XRAY_WEIGHTS              = [V(10)], // [Ortho King]
    BISHOP_PAIR_WEIGHTS       = [V(39), V(73)], // [MG, EG]
    ROOK_OPEN_WEIGHTS         = [V(44), V(1)], // [MG, EG]
    PASSED_PAWN_MG            = [V(-18), V(-32), V(-34), V(-12), V(-16), V(-34)], // by relative rank 1-6
    PASSED_PAWN_EG            = [V(-46), V(-22), V(26), V(79), V(173), V(114)], // by relative rank 1-6
    ENEMY_KING_DIST_MG        = [V(-101), V(35), V(19), V(15), V(13), V(8)], // enemy king→passer dist, 7 clamps to 6
    ENEMY_KING_DIST_EG        = [V(-51), V(-1), V(39), V(53), V(65), V(71)], // enemy king→passer dist, 7 clamps to 6
    DOUBLED_PAWN_WEIGHTS      = [V(2), V(-45)], // [MG, EG]
    ISOLATED_PAWN_WEIGHTS     = [V(-9), V(-13)], // [MG, EG]
    PHALANX_MG                = [V(7), V(16), V(28), V(61), V(160), V(-328)], // by relative rank 2-7
    PHALANX_EG                = [V(-8), V(1), V(23), V(89), V(197), V(570)], // by relative rank 2-7
    DEFENDED_PAWN_MG          = [CV(0), V(32), V(21), V(18), V(29), V(235)], // by relative rank 2-7 (rank 2 unreachable)
    DEFENDED_PAWN_EG          = [CV(0), V(16), V(13), V(29), V(61), V(-6)], // by relative rank 2-7 (rank 2 unreachable)
