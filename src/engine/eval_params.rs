...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S( 148,  134),  S( 177,  129),  S( 188,  118),  S( 230,   88),
        S(  41,   99),  S(  76,   94),  S(  93,   67),  S( 100,   68),
        S(  -1,   54),  S(  30,   44),  S(  28,   22),  S(  65,   12),
        S(  -5,   34),  S(  31,   31),  S(  31,    9),  S(  50,   11),
        S(   5,   25),  S(  43,   18),  S(  18,   11),  S(  30,   12),
        S(  -4,   30),  S(  34,   26),  S(  22,   19),  S(  -2,   29),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],
    KNIGHT = [
        S(  57,  -79),  S( -30,    2),  S( 162,  -22),  S( 254,  -44),
        S( 223,  -46),  S( 215,  -16),  S( 258,  -19),  S( 271,  -25),
        S( 190,  -21),  S( 256,  -20),  S( 270,   -7),  S( 327,  -20),
        S( 227,  -25),  S( 227,    2),  S( 275,    1),  S( 251,   22),
        S( 194,  -30),  S( 224,   -8),  S( 234,    3),  S( 246,    7),
        S( 165,  -37),  S( 209,  -19),  S( 217,  -22),  S( 236,   -3),
        S( 172,  -48),  S( 181,  -25),  S( 203,  -33),  S( 210,  -18),
        S(  97,  -56),  S( 179,  -66),  S( 165,  -37),  S( 188,  -42),
    ],
    BISHOP = [
        S( 195,    6),  S( 221,    4),  S( 204,    2),  S( 217,    1),
        S( 231,   -1),  S( 246,   18),  S( 261,   11),  S( 259,    4),
        S( 271,    5),  S( 277,   19),  S( 294,   17),  S( 301,    1),
        S( 258,    8),  S( 258,   22),  S( 277,   14),  S( 310,   22),
        S( 248,   -1),  S( 267,    7),  S( 261,   26),  S( 287,   24),
        S( 241,    0),  S( 271,   -5),  S( 266,   20),  S( 263,   25),
        S( 251,  -29),  S( 273,   -6),  S( 277,   -8),  S( 257,   12),
        S( 228,  -19),  S( 251,   -8),  S( 224,   -4),  S( 235,    6),
    ],
    ROOK = [
        S( 255,   20),  S( 265,   18),  S( 270,   18),  S( 258,   23),
        S( 273,   13),  S( 294,   14),  S( 314,   10),  S( 333,    4),
        S( 243,   19),  S( 283,   13),  S( 289,    7),  S( 325,   -5),
        S( 233,   26),  S( 243,   17),  S( 254,   18),  S( 297,    3),
        S( 199,   18),  S( 216,   20),  S( 222,   21),  S( 264,   10),
        S( 196,   14),  S( 226,    2),  S( 225,   11),  S( 236,    8),
        S( 182,   10),  S( 218,   -7),  S( 224,   -1),  S( 225,    1),
        S( 224,    3),  S( 222,    0),  S( 225,    0),  S( 250,  -14),
    ],
    QUEEN = [
        S( 174,  298),  S( 160,  334),  S( 138,  341),  S( 182,  312),
        S( 184,  306),  S( 136,  343),  S( 176,  318),  S( 174,  334),
        S( 199,  285),  S( 201,  302),  S( 188,  326),  S( 211,  317),
        S( 211,  260),  S( 177,  328),  S( 200,  309),  S( 190,  325),
        S( 200,  293),  S( 212,  279),  S( 194,  311),  S( 199,  318),
        S( 207,  232),  S( 223,  255),  S( 213,  273),  S( 205,  286),
        S( 218,  189),  S( 227,  182),  S( 247,  168),  S( 226,  225),
        S( 210,  169),  S( 205,  179),  S( 194,  189),  S( 227,  185),
    ],
    KING = [
        S(  75, -162),  S( -18,  -49),  S(  18,  -30),  S( -46,  -19),
        S( 123,  -78),  S(  80,    4),  S(  75,    9),  S(  23,    9),
        S(  14,  -26),  S(   6,   33),  S(  -4,   39),  S( -48,   45),
        S(  -1,  -18),  S( -35,   34),  S( -21,   44),  S( -65,   56),
        S( -87,  -13),  S( -58,   17),  S( -55,   36),  S( -49,   49),
        S(-116,   -9),  S( -64,    1),  S( -73,   25),  S( -73,   39),
        S( -45,  -40),  S( -42,  -18),  S( -77,   11),  S( -88,   19),
        S( -42,  -88),  S( -16,  -52),  S( -70,  -18),  S( -55,  -27),
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS    = [CV(0), V(86), V(160), V(213), V(168), V(140)], // [0, 1, 2, 3, 4, 5] attackers × weak
