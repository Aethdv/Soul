...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S( -22,  293),  S(   6,  278),  S(  48,  249),  S(  87,  204),
        S( -42,  184),  S( -20,  192),  S(  27,  134),  S(  24,  130),
        S( -45,   89),  S( -21,   79),  S( -17,   54),  S(  -3,   44),
        S( -50,   58),  S( -33,   63),  S( -27,   41),  S( -10,   39),
        S( -46,   53),  S( -19,   58),  S( -32,   42),  S( -19,   50),
        S( -51,   55),  S( -21,   59),  S( -30,   49),  S( -32,   60),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],
    KNIGHT = [
        S(-120,   40),  S(-108,  120),  S( -28,  125),  S(  23,  131),
        S(  32,  107),  S(  37,  143),  S(  86,  140),  S(  67,  145),
        S(  51,  126),  S(  71,  149),  S(  93,  165),  S( 110,  163),
        S(  53,  145),  S(  46,  170),  S(  84,  180),  S(  79,  189),
        S(  27,  147),  S(  57,  156),  S(  54,  180),  S(  66,  188),
        S(  10,  132),  S(  38,  155),  S(  45,  158),  S(  59,  179),
        S(  18,  134),  S(   7,  138),  S(  29,  152),  S(  41,  160),
        S( -38,  110),  S(   1,  119),  S(   9,  128),  S(   7,  141),
    ],
    BISHOP = [
        S(   5,  157),  S(  -9,  168),  S(  -9,  164),  S( -47,  176),
        S(  35,  141),  S(  45,  167),  S(  52,  163),  S(  45,  163),
        S(  66,  165),  S(  73,  166),  S(  73,  177),  S(  73,  169),
        S(  39,  163),  S(  53,  176),  S(  67,  179),  S(  78,  188),
        S(  44,  149),  S(  42,  177),  S(  53,  184),  S(  68,  185),
        S(  49,  154),  S(  55,  166),  S(  52,  181),  S(  57,  182),
        S(  57,  144),  S(  62,  162),  S(  69,  150),  S(  48,  173),
        S(  37,  131),  S(  61,  150),  S(  31,  150),  S(  27,  157),
    ],
    ROOK = [
        S( -33,  333),  S( -49,  342),  S( -47,  348),  S( -51,  344),
        S( -32,  328),  S( -34,  340),  S(  -8,  341),  S(  -2,  338),
        S( -40,  328),  S(  -3,  328),  S( -11,  329),  S(   1,  324),
        S( -50,  332),  S( -34,  327),  S( -28,  333),  S( -26,  329),
        S( -73,  329),  S( -61,  330),  S( -60,  334),  S( -41,  332),
        S( -70,  320),  S( -47,  314),  S( -52,  320),  S( -46,  325),
        S( -85,  326),  S( -59,  319),  S( -52,  320),  S( -49,  321),
        S( -61,  332),  S( -58,  326),  S( -61,  328),  S( -42,  319),
    ],
    QUEEN = [
        S(  19,  644),  S(  15,  663),  S(   9,  700),  S(  15,  693),
        S(  53,  645),  S(   4,  688),  S(  16,  716),  S(  -8,  748),
        S(  66,  647),  S(  65,  659),  S(  28,  719),  S(  40,  721),
        S(  65,  658),  S(  40,  699),  S(  38,  705),  S(  25,  724),
        S(  54,  669),  S(  56,  685),  S(  39,  697),  S(  41,  710),
        S(  57,  641),  S(  63,  663),  S(  61,  675),  S(  53,  682),
        S(  72,  606),  S(  66,  613),  S(  74,  622),  S(  70,  652),
        S(  46,  624),  S(  39,  628),  S(  44,  621),  S(  64,  629),
    ],
    KING = [
        S(  74, -153),  S(   3,  -54),  S(  14,  -42),  S( -52,  -19),
        S(-110,  -10),  S(   0,   29),  S( -35,   46),  S(  44,   26),
        S(-112,   10),  S(   7,   42),  S(  14,   55),  S( -27,   65),
        S(-141,    8),  S( -68,   44),  S( -65,   64),  S( -96,   76),
        S(-157,   -4),  S( -90,   25),  S( -70,   48),  S(-101,   68),
        S( -85,  -24),  S( -31,   -3),  S( -63,   25),  S( -62,   40),
        S(  10,  -57),  S(  11,  -32),  S( -22,   -4),  S( -39,   10),
        S(  15, -111),  S(  27,  -71),  S(   5,  -46),  S(  14,  -54),
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS    = [CV(0), V(129), V(221), V(390), V(459), V(499)], // [0, 1, 2, 3, 4, 5] attackers × weak
    KING_SAFETY_WEIGHTS = [V(14), V(10), V(7)], // [Pawn Shield, Ortho Exp, Diag Exp]
    XRAY_WEIGHTS        = [V(10)], // [Ortho King]
    BISHOP_PAIR_WEIGHTS = [V(26), V(76)], // [MG, EG]
}
