...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  17,   77),  S(  52,   36),  S(  36,   67),  S(  53,   41),
        S(  12,   24),  S(  23,   23),  S(  79,  -26),  S(  60,  -52),
        S( -17,    1),  S(  -5,   -8),  S(   7,  -27),  S(  23,  -42),
        S( -31,  -11),  S( -26,   -7),  S( -19,  -16),  S(   2,  -22),
        S( -40,  -14),  S( -34,  -13),  S( -35,   -8),  S( -27,   -7),
        S( -38,   -7),  S( -25,   -6),  S( -26,    0),  S( -33,    0),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-169, -132),  S(-110,  -41),  S( -86,  -16),  S( -34,  -14),
        S(   8,  -36),  S(  18,   -3),  S(  67,   -4),  S(  44,    3),
        S(  21,  -19),  S(  50,    0),  S(  78,   19),  S( 101,   20),
        S(  26,   -6),  S(  18,   24),  S(  70,   36),  S(  60,   49),
        S(  -6,    4),  S(  35,   15),  S(  28,   39),  S(  38,   52),
        S( -31,   -9),  S(   8,   11),  S(  12,   21),  S(  27,   43),
        S( -28,  -12),  S( -38,   -3),  S( -10,   13),  S(   2,   20),
        S( -90,  -33),  S( -55,  -43),  S( -37,  -14),  S( -31,    5),
    ],

    BISHOP = [
        S( -58,   -1),  S( -70,   10),  S( -84,    3),  S(-135,   20),
        S(   1,  -17),  S(  23,    5),  S(  15,    3),  S(  11,    1),
        S(  25,   -2),  S(  29,    3),  S(  35,   14),  S(  44,    4),
        S(  -1,   -5),  S(  13,   10),  S(  34,   13),  S(  46,   25),
        S(   3,  -17),  S(   5,    9),  S(  11,   18),  S(  29,   22),
        S(  -1,  -12),  S(  16,   -2),  S(  11,   15),  S(   9,   18),
        S(  -1,  -28),  S(  14,  -23),  S(  25,  -22),  S(  -1,    5),
        S( -13,  -42),  S(   9,  -10),  S( -25,  -24),  S( -17,   -4),
    ],

    ROOK = [
        S( -16,   13),  S( -53,   27),  S( -44,   32),  S( -51,   24),
        S(   4,    5),  S(  -1,   15),  S(  26,   12),  S(  30,    4),
        S(   9,    2),  S(  51,   -5),  S(  44,   -7),  S(  42,  -12),
        S(   4,    5),  S(  20,   -1),  S(  23,    2),  S(  21,   -5),
        S( -21,    6),  S(  -4,    3),  S(  -9,    4),  S(   5,    2),
        S( -15,   -9),  S(  10,  -21),  S(  -2,  -11),  S(  -2,   -4),
        S( -32,   -6),  S(  -7,  -13),  S(  -4,  -14),  S(  -4,  -14),
        S( -11,   -5),  S(  -4,  -10),  S( -16,   -4),  S(   6,  -19),
    ],

    QUEEN = [
        S( -34,  -71),  S( -18,  -61),  S( -35,  -10),  S( -26,   -6),
        S(  26,  -25),  S( -32,   21),  S( -15,   36),  S( -45,   69),
        S(  31,   -7),  S(  39,  -15),  S(   5,   45),  S(   4,   53),
        S(  22,    7),  S(  -3,   51),  S(   2,   36),  S( -17,   71),
        S(   4,   15),  S(  12,   28),  S(  -8,   43),  S(  -5,   53),
        S(  11,  -27),  S(  12,    4),  S(   8,   23),  S(   2,   24),
        S(  22,  -67),  S(  17,  -62),  S(  25,  -47),  S(  18,  -11),
        S( -14,  -48),  S( -12,  -45),  S( -11,  -49),  S(   6,  -31),
    ],

    KING = [
        S(  41, -130),  S(  -2,  -37),  S(  18,  -28),  S( -23,  -15),
        S( -75,    6),  S(  22,   46),  S(  -4,   52),  S(  58,   30),
        S( -65,    7),  S(  48,   49),  S(  34,   59),  S(  18,   64),
        S(-101,   -1),  S( -17,   40),  S( -32,   63),  S( -86,   76),
        S(-114,  -15),  S( -39,   19),  S( -38,   44),  S( -85,   68),
        S( -37,  -32),  S(  23,   -9),  S(  -9,   21),  S( -12,   34),
        S(  70,  -63),  S(  70,  -32),  S(  37,   -5),  S(  15,    8),
        S(  76, -123),  S(  89,  -79),  S(  61,  -47),  S(  64,  -56),
    ],
}
...
define_weight_params! {
    ...
    attacker           = [CV(0), V(179), V(282), V(472), V(555), V(571)], // [0, 1, 2, 3, 4, 5] attackers × weak
    ...
    passed_pawn_mg     = [V(-7), V(-21), V(-24), V(-1), V(-4), V(56)], // by relative rank 1-6
    passed_pawn_eg     = [V(-64), V(-40), V(8), V(61), V(157), V(173)], // by relative rank 1-6
    enemy_king_dist_mg = [V(-111), V(22), V(8), V(4), V(2), V(-4)], // enemy king→passer dist, 7 clamps to 6
    ...
    phalanx_mg         = [V(6), V(16), V(27), V(62), V(111), V(-186)], // by relative rank 2-7
    phalanx_eg         = [V(-7), V(1), V(24), V(88), V(211), V(375)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(32), V(21), V(18), V(28), V(170)], // by relative rank 2-7 (rank 2 unreachable)
    defended_pawn_eg   = [CV(0), V(16), V(13), V(29), V(62), V(14)], // by relative rank 2-7 (rank 2 unreachable)
