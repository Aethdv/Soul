...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(   5,   79),  S( -13,   82),  S(  12,   74),  S(  44,   52),
        S( -48,   48),  S( -33,   53),  S( -15,   32),  S(  -8,   30),
        S( -55,   13),  S( -27,    7),  S( -32,   -1),  S( -19,   -8),
        S( -62,    0),  S( -42,    5),  S( -35,   -8),  S( -24,  -14),
        S( -57,   -3),  S( -26,    0),  S( -44,   -5),  S( -43,   -6),
        S( -66,    2),  S( -32,    7),  S( -43,    6),  S( -64,   14),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-197, -114),  S(-145,  -68),  S(-158,  -56),  S(-102,  -58),
        S( -86,  -78),  S( -92,  -63),  S( -63,  -61),  S( -84,  -48),
        S( -79,  -79),  S( -58,  -61),  S( -67,  -44),  S( -48,  -48),
        S( -72,  -67),  S( -81,  -46),  S( -66,  -40),  S( -68,  -36),
        S( -91,  -61),  S( -80,  -54),  S( -79,  -42),  S( -74,  -37),
        S(-111,  -68),  S( -86,  -61),  S( -82,  -58),  S( -74,  -48),
        S(-105,  -89),  S(-103,  -65),  S( -96,  -61),  S( -90,  -57),
        S(-136,  -94),  S(-120,  -76),  S(-110,  -72),  S(-108,  -69),
    ],

    BISHOP = [
        S(-101,  -62),  S(-102,  -46),  S(-150,  -44),  S(-129,  -39),
        S( -76,  -52),  S( -80,  -43),  S( -69,  -46),  S( -91,  -43),
        S( -65,  -47),  S( -54,  -44),  S( -68,  -35),  S( -53,  -41),
        S( -69,  -51),  S( -61,  -37),  S( -61,  -35),  S( -49,  -31),
        S( -61,  -55),  S( -72,  -41),  S( -63,  -35),  S( -57,  -31),
        S( -68,  -48),  S( -60,  -44),  S( -63,  -41),  S( -59,  -37),
        S( -55,  -59),  S( -52,  -53),  S( -57,  -51),  S( -68,  -42),
        S( -70,  -56),  S( -57,  -52),  S( -85,  -45),  S( -86,  -48),
    ],

    ROOK = [
        S(-208,  -33),  S(-216,  -30),  S(-219,  -26),  S(-216,  -30),
        S(-204,  -33),  S(-205,  -29),  S(-185,  -32),  S(-180,  -34),
        S(-212,  -35),  S(-184,  -40),  S(-191,  -36),  S(-180,  -42),
        S(-215,  -34),  S(-203,  -36),  S(-199,  -33),  S(-196,  -37),
        S(-227,  -39),  S(-220,  -38),  S(-218,  -34),  S(-210,  -37),
        S(-239,  -39),  S(-218,  -44),  S(-222,  -41),  S(-213,  -42),
        S(-249,  -39),  S(-228,  -45),  S(-219,  -47),  S(-215,  -47),
        S(-225,  -42),  S(-222,  -41),  S(-218,  -45),  S(-204,  -51),
    ],

    QUEEN = [
        S(-470,   54),  S(-470,   68),  S(-479,   86),  S(-476,   89),
        S(-453,   55),  S(-494,   96),  S(-478,   99),  S(-490,  116),
        S(-450,   63),  S(-453,   72),  S(-472,  104),  S(-469,  108),
        S(-444,   56),  S(-463,   88),  S(-467,   93),  S(-474,  104),
        S(-449,   62),  S(-457,   84),  S(-463,   87),  S(-468,   97),
        S(-449,   49),  S(-442,   55),  S(-448,   62),  S(-452,   64),
        S(-438,   25),  S(-439,   23),  S(-434,   19),  S(-443,   43),
        S(-450,   26),  S(-455,   31),  S(-460,   36),  S(-450,   39),
    ],

    KING = [
        S( -58,  -89),  S( -26,  -17),  S( -22,  -14),  S(   6,    6),
        S( -66,  -17),  S(  21,   28),  S(   9,   38),  S(  24,   37),
        S( -11,    8),  S(  49,   23),  S(  48,   33),  S(  31,   38),
        S( -22,   -2),  S(  11,   21),  S(   7,   29),  S( -16,   36),
        S( -57,    0),  S( -37,   18),  S( -28,   27),  S( -48,   39),
        S( -55,   -3),  S( -39,    6),  S( -44,   16),  S( -47,   23),
        S(  -7,  -20),  S(  -8,  -12),  S( -30,    2),  S( -37,    6),
        S(   7,  -54),  S(  18,  -34),  S(  -4,  -22),  S(   4,  -29),
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS    = [CV(0), V(10), V(10), V(20), V(6), V(30)], // [0, 1, 2, 3, 4, 5] attackers × weak
    KING_SAFETY_WEIGHTS = [V(7), V(2), V(2)], // [Pawn Shield, Ortho Exp, Diag Exp]
    XRAY_WEIGHTS        = [V(2)], // [Ortho King]
    BISHOP_PAIR_WEIGHTS = [V(24), V(66)], // [MG, EG]
}
