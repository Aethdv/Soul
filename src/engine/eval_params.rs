...
define_psqt_params! {
    PAWN = [
        ...
        S(  72,    0),  S(  15,   30),  S(  21,   42),  S(  81,   20),
        S(  -8,   -2),  S(  17,   -3),  S(  37,   -4),  S(  59,  -21),
        S( -21,    0),  S(  15,   -8),  S(  29,  -16),  S(  56,  -24),
        S( -41,    0),  S(  -8,   -3),  S(  -7,   -5),  S(  13,  -15),
        S( -49,    0),  S( -23,   -4),  S( -37,    3),  S( -52,    4),
        S( -59,    0),  S( -21,    6),  S( -18,    4),  S( -64,   10),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-285,  -21),  S(  28,  -39),  S( -91,   14),  S( -13,   14),
        S(   1,  -25),  S( -27,    2),  S(  66,  -21),  S(  88,    0),
        S(  -1,  -23),  S(  88,   -3),  S(  94,    3),  S( 132,    1),
        S(  59,  -34),  S(  30,   24),  S(  68,   17),  S(  77,   22),
        S(   6,   -2),  S(  30,    3),  S(  40,   20),  S(  42,   36),
        S( -54,   -1),  S(   3,    2),  S(   8,   19),  S(  28,   27),
        S( -50,  -35),  S( -44,   18),  S( -25,    5),  S( -17,   24),
        S(-104,  -45),  S( -98,  -14),  S( -57,   -5),  S( -34,    8),
    ],

    BISHOP = [
        S(-108,   30),  S( -42,    9),  S(-137,   25),  S(-131,   30),
        S( -19,   -1),  S(  -9,   17),  S(   3,   10),  S(  -4,   12),
        S(  24,  -12),  S(  44,    2),  S(  43,    9),  S(  85,   -7),
        S(   0,  -10),  S(  33,    8),  S(  46,   -3),  S(  73,   -6),
        S(   6,  -11),  S(  17,   -6),  S(  33,    6),  S(  47,    0),
        S(  -6,   -7),  S(  26,   -5),  S(  19,   -8),  S(  21,    3),
        S(  11,  -18),  S(  15,  -19),  S(   6,  -10),  S(  -9,    4),
        S( -19,  -15),  S(  21,  -21),  S( -42,   -2),  S( -36,   -4),
    ],

    ROOK = [
        S(   6,   11),  S(  -7,   18),  S(   0,   21),  S(  10,   13),
        S(   8,    4),  S(   4,    6),  S(  63,  -16),  S(  86,  -21),
        S(   8,    0),  S(  57,  -11),  S(  62,  -14),  S(  96,  -31),
        S(  -5,    9),  S(  23,   -1),  S(  34,   -2),  S(  41,   -6),
        S( -36,   12),  S( -21,    6),  S(  -2,    0),  S(  12,   -2),
        S( -67,    8),  S( -34,    5),  S( -33,    6),  S( -11,   -5),
        S( -89,   16),  S( -60,    1),  S( -28,   -8),  S( -20,  -12),
        S( -58,   12),  S( -32,    2),  S( -24,  -11),  S(   4,  -23),
    ],

    QUEEN = [
        S( -27,   18),  S( -33,   25),  S( -22,   30),  S( -23,   36),
        S(  -5,    5),  S( -93,   78),  S( -32,   51),  S( -43,   68),
        S(   8,   19),  S(  12,   10),  S( -10,   54),  S(   3,   38),
        S(  34,  -31),  S( -14,   52),  S(  -2,   45),  S( -13,   53),
        S(   7,    4),  S(  10,    9),  S(  -1,   26),  S(  -1,   23),
        S(   8,  -31),  S(  32,  -33),  S(  17,  -10),  S(  23,  -12),
        S(  33,  -62),  S(  29,  -87),  S(  44,  -86),  S(  28,  -47),
        S(  20,  -72),  S(  13,  -77),  S(   0,  -59),  S(  -3,  -34),
    ],

    KING = [
        S(-203, -103),  S(  -4,  -20),  S( -12,  -30),  S( 127,   15),
        S(-106,  -55),  S(  28,   11),  S( 130,   29),  S(  90,   38),
        S(  89,  -22),  S(  52,   10),  S(   1,   30),  S( -26,   24),
        S(  49,  -26),  S(  56,   10),  S(  -1,   19),  S( -41,   30),
        S( -24,   -9),  S( -41,   27),  S( -33,   37),  S( -25,   45),
        S( -48,   -3),  S( -55,   23),  S( -71,   38),  S( -68,   43),
        S(  38,  -29),  S(  14,   -7),  S( -37,   19),  S( -56,   22),
        S(  67,  -76),  S(  80,  -42),  S(  19,  -14),  S(  -7,  -21),
    ],
}
...
define_simd_params! {
    mobility_open {
        mg = [V(3), V(-5), V(19), V(-3)], // [mobility, battery, threats, xray threats]
        eg = [V(-6), V(-7), V(11), V(-5)],
    },
    mobility_closed {
        mg = [V(3), V(1), V(-35), V(0)],
        eg = [V(30), V(20), V(23), V(-37)],
    },
}
...
define_weight_params! {
    ...
    king_safety = [V(35), V(7), V(7)], // [Pawn Shield, Ortho Exp, Diag Exp]
    attacker    = [CV(0), V(119), V(172), V(208), V(191), V(239)], // [0, 1, 2, 3, 4, 5] attackers × weak
    xray        = [V(13)], // [Ortho King]
    king_danger = [V(0)]; // pressure curvature, over DANGER_SCALE; floored at 0, the data pulls under

    tempo             = [V(16), V(0)], // [MG, EG], side-to-move initiative
    bishop_pair       = [V(64), V(54)], // [MG, EG]
    rook_open         = [V(39), V(-7)], // [MG, EG]
    minor_behind_pawn = [V(21), V(25)]; // [MG, EG]

    doubled_pawn       = [V(-25), V(-24)], // [MG, EG]
    isolated_pawn      = [V(-14), V(-10)], // [MG, EG]
    backward_pawn      = [V(-11), V(-10)], // [MG, EG]
    phalanx_mg         = [V(19), V(29), V(44), V(80), V(328), V(-38)], // by relative rank 2-7
    phalanx_eg         = [V(14), V(-1), V(6), V(41), V(26), V(546)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(52), V(35), V(46), V(76), V(295)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    defended_pawn_eg   = [CV(0), V(9), V(3), V(10), V(29), V(-8)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    passed_pawn_mg     = [V(-62), V(-49), V(-27), V(2), V(61), V(122)], // by relative rank 2-7
    passed_pawn_eg     = [V(-5), V(0), V(22), V(46), V(76), V(86)], // by relative rank 2-7
    enemy_king_dist_mg = [V(-161), V(-4), V(1), V(12), V(18), V(27)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-12), V(5), V(22), V(30), V(36), V(41)]; // enemy king→passer dist, 7 clamps to 6
}
