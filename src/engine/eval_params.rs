...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S( -12,   35),  S(  -3,   27),  S(   9,   11),  S(  25,   -7),
        S( -24,   25),  S( -21,   29),  S( -12,   21),  S(   7,   15),
        S( -32,   20),  S( -27,   23),  S( -25,   27),  S( -19,   28),
        S( -30,   24),  S( -19,   27),  S( -18,   33),  S( -23,   32),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-166,   -7),  S(-127,   93),  S( -63,  108),  S(  -6,  110),
        S(   8,   91),  S(  19,  125),  S(  79,  116),  S(  53,  126),
        S(  23,  101),  S(  50,  128),  S(  78,  144),  S( 100,  147),
        S(  30,  121),  S(  21,  148),  S(  67,  161),  S(  57,  175),
        S(   0,  126),  S(  40,  134),  S(  30,  164),  S(  38,  175),
        S( -21,  110),  S(  13,  136),  S(  17,  146),  S(  31,  164),
        S( -19,  110),  S( -27,  117),  S(  -1,  139),  S(   9,  144),
        S( -76,   88),  S( -43,   82),  S( -25,  111),  S( -21,  126),
    ],

    BISHOP = [
        S( -30,  113),  S( -32,  120),  S( -49,  111),  S( -75,  125),
        S(  12,   98),  S(  37,  119),  S(  36,  116),  S(  33,  116),
        S(  41,  111),  S(  49,  114),  S(  55,  129),  S(  61,  120),
        S(  15,  109),  S(  31,  122),  S(  49,  128),  S(  58,  142),
        S(  24,   96),  S(  21,  125),  S(  28,  134),  S(  45,  138),
        S(  21,   98),  S(  33,  114),  S(  30,  129),  S(  27,  133),
        S(  21,   80),  S(  32,   93),  S(  42,   93),  S(  19,  119),
        S(   9,   72),  S(  31,  101),  S(  -3,   93),  S(   8,  107),
    ],

    ROOK = [
        S( -82,  160),  S(-108,  169),  S( -88,  169),  S( -98,  163),
        S( -68,  149),  S( -74,  160),  S( -49,  157),  S( -42,  150),
        S( -62,  143),  S( -23,  136),  S( -33,  135),  S( -33,  131),
        S( -70,  147),  S( -48,  138),  S( -49,  141),  S( -54,  138),
        S( -90,  146),  S( -73,  143),  S( -79,  144),  S( -65,  143),
        S( -86,  136),  S( -60,  122),  S( -76,  134),  S( -72,  138),
        S(-101,  139),  S( -77,  132),  S( -74,  133),  S( -73,  130),
        S( -82,  141),  S( -75,  137),  S( -85,  140),  S( -66,  126),
    ],

    QUEEN = [
        S(-203,  467),  S(-184,  468),  S(-207,  516),  S(-187,  501),
        S(-137,  461),  S(-194,  507),  S(-184,  537),  S(-212,  572),
        S(-129,  465),  S(-129,  476),  S(-166,  540),  S(-161,  543),
        S(-136,  477),  S(-158,  523),  S(-158,  521),  S(-175,  552),
        S(-148,  487),  S(-142,  503),  S(-159,  514),  S(-162,  535),
        S(-146,  461),  S(-139,  478),  S(-144,  498),  S(-148,  501),
        S(-130,  411),  S(-134,  425),  S(-127,  431),  S(-133,  467),
        S(-159,  436),  S(-159,  436),  S(-156,  429),  S(-144,  448),
    ],

    KING = [
        S(  72, -158),  S(   1,  -50),  S( -17,  -37),  S( -96,  -14),
        S(-148,    8),  S( -27,   45),  S( -58,   51),  S(  41,   22),
        S(-137,   14),  S(  -3,   48),  S(  -6,   58),  S( -55,   69),
        S(-163,    6),  S( -79,   44),  S( -79,   61),  S(-136,   75),
        S(-177,  -13),  S( -89,   21),  S( -84,   44),  S(-126,   64),
        S( -87,  -32),  S( -26,   -8),  S( -63,   21),  S( -67,   35),
        S(  22,  -66),  S(  20,  -35),  S( -14,   -6),  S( -36,    9),
        S(  30, -127),  S(  39,  -82),  S(  13,  -50),  S(  15,  -58),
    ],
}
...
define_weight_params! {
    ...
    ATTACKER_WEIGHTS          = [CV(0), V(169), V(255), V(440), V(524), V(583)], // [0, 1, 2, 3, 4, 5] attackers × weak
    KING_SAFETY_WEIGHTS       = [V(21), V(10), V(8)], // [Pawn Shield, Ortho Exp, Diag Exp]
    XRAY_WEIGHTS              = [V(10)], // [Ortho King]
    BISHOP_PAIR_WEIGHTS       = [V(32), V(82)], // [MG, EG]
    ROOK_OPEN_WEIGHTS         = [V(37), V(5)], // [MG, EG]
    PASSED_PAWN_MG            = [V(-11), V(-25), V(-27), V(-5), V(-5), V(-32)], // by relative rank 1-6
    PASSED_PAWN_EG            = [V(-39), V(-20), V(27), V(81), V(178), V(129)], // by relative rank 1-6
    ENEMY_KING_DIST_MG        = [V(-110), V(29), V(13), V(9), V(8), V(3)], // enemy king→passer dist, 7 clamps to 6
    ENEMY_KING_DIST_EG        = [V(-47), V(-2), V(37), V(51), V(64), V(71)], // enemy king→passer dist, 7 clamps to 6
    DOUBLED_PAWN_WEIGHTS      = [V(1), V(-40)], // [MG, EG]
    ISOLATED_PAWN_WEIGHTS     = [V(-10), V(-13)], // [MG, EG]
    PHALANX_MG                = [V(6), V(15), V(27), V(59), V(160), V(-299)], // by relative rank 2-7
    PHALANX_EG                = [V(-6), V(2), V(22), V(92), V(272), V(654)], // by relative rank 2-7
    DEFENDED_PAWN_MG          = [CV(0), V(29), V(19), V(18), V(28), V(207)], // by relative rank 2-7 (rank 2 unreachable)
    DEFENDED_PAWN_EG          = [CV(0), V(16), V(13), V(29), V(70), V(56)], // by relative rank 2-7 (rank 2 unreachable)
    BACKWARD_PAWN_WEIGHTS     = [V(-7), V(-18)], // [MG, EG]
    TEMPO_WEIGHTS             = [V(29), V(36)], // [MG, EG], side-to-move initiative
    MINOR_BEHIND_PAWN_WEIGHTS = [V(13), V(30)], // [MG, EG]
}
