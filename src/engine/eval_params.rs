...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  25,   79),  S(  60,   38),  S(  44,   69),  S(  61,   42),
        S(  10,   23),  S(  21,   23),  S(  76,  -26),  S(  58,  -53),
        S( -20,    0),  S(  -7,   -9),  S(   4,  -28),  S(  21,  -43),
        S( -34,  -11),  S( -29,   -8),  S( -21,  -16),  S(   0,  -22),
        S( -42,  -15),  S( -36,  -13),  S( -37,   -9),  S( -29,   -8),
        S( -41,   -8),  S( -27,   -7),  S( -29,   -1),  S( -35,   -1),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-168, -132),  S(-110,  -41),  S( -86,  -16),  S( -33,  -14),
        S(   9,  -36),  S(  19,   -3),  S(  68,   -4),  S(  45,    3),
        S(  22,  -19),  S(  50,    0),  S(  79,   19),  S( 102,   20),
        S(  26,   -6),  S(  18,   24),  S(  71,   36),  S(  61,   49),
        S(  -5,    4),  S(  35,   15),  S(  28,   39),  S(  38,   52),
        S( -31,   -9),  S(   8,   11),  S(  12,   21),  S(  28,   43),
        S( -27,  -12),  S( -38,   -3),  S(  -9,   13),  S(   2,   20),
        S( -89,  -34),  S( -54,  -43),  S( -36,  -14),  S( -31,    5),
    ],

    BISHOP = [
        S( -59,    0),  S( -68,   10),  S( -85,    4),  S(-135,   21),
        S(   1,  -16),  S(  22,    6),  S(  15,    4),  S(  11,    2),
        S(  25,   -1),  S(  29,    3),  S(  34,   15),  S(  44,    5),
        S(  -1,   -4),  S(  13,   10),  S(  34,   14),  S(  45,   25),
        S(   3,  -17),  S(   4,   10),  S(  11,   19),  S(  28,   22),
        S(  -1,  -12),  S(  16,   -1),  S(  11,   16),  S(   9,   18),
        S(  -1,  -27),  S(  14,  -22),  S(  24,  -21),  S(  -2,    6),
        S( -13,  -41),  S(   9,   -9),  S( -25,  -23),  S( -17,   -3),
    ],

    ROOK = [
        S( -16,   12),  S( -53,   27),  S( -44,   32),  S( -51,   24),
        S(   5,    5),  S(   0,   14),  S(  26,   12),  S(  30,    4),
        S(  10,    2),  S(  51,   -5),  S(  44,   -8),  S(  43,  -13),
    ...
    QUEEN = [
        S( -34,  -70),  S( -17,  -61),  S( -35,  -10),  S( -26,   -6),
        S(  27,  -24),  S( -32,   21),  S( -15,   36),  S( -45,   69),
        S(  31,   -7),  S(  40,  -15),  S(   5,   45),  S(   4,   53),
        S(  22,    7),  S(  -2,   51),  S(   2,   36),  S( -17,   71),
        S(   4,   15),  S(  12,   28),  S(  -8,   43),  S(  -5,   53),
        S(  11,  -27),  S(  12,    4),  S(   8,   23),  S(   2,   24),
        S(  23,  -67),  S(  18,  -62),  S(  25,  -47),  S(  19,  -11),
        S( -14,  -48),  S( -12,  -45),  S( -10,  -50),  S(   6,  -31),
    ],

    KING = [
        S(  41, -131),  S(  -3,  -36),  S(  19,  -28),  S( -23,  -15),
        S( -75,    5),  S(  22,   45),  S(  -5,   52),  S(  57,   30),
        S( -66,    7),  S(  47,   48),  S(  32,   59),  S(  17,   63),
        S(-101,   -1),  S( -18,   40),  S( -33,   63),  S( -80,   75),
        S(-114,  -16),  S( -39,   19),  S( -37,   44),  S( -85,   67),
        S( -36,  -33),  S(  24,   -9),  S(  -8,   20),  S( -12,   34),
        S(  70,  -64),  S(  70,  -32),  S(  37,   -5),  S(  15,    8),
        S(  76, -123),  S(  90,  -80),  S(  61,  -47),  S(  64,  -56),
    ],
}
...
define_weight_params! {
    ...
    attacker           = [CV(0), V(179), V(282), V(471), V(555), V(571)], // [0, 1, 2, 3, 4, 5] attackers × weak
    ...
    passed_pawn_mg     = [V(-2), V(-16), V(-19), V(4), V(1), V(50)], // by relative rank 1-6
    passed_pawn_eg     = [V(-58), V(-34), V(14), V(66), V(162), V(177)], // by relative rank 1-6
    enemy_king_dist_mg = [V(-116), V(18), V(3), V(-1), V(-3), V(-9)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-39), V(12), V(52), V(65), V(77), V(85)], // enemy king→passer dist, 7 clamps to 6
    doubled_pawn       = [V(3), V(-45)], // [MG, EG]
    isolated_pawn      = [V(-9), V(-12)], // [MG, EG]
    phalanx_mg         = [V(6), V(16), V(28), V(62), V(110), V(-185)], // by relative rank 2-7
    phalanx_eg         = [V(-7), V(1), V(24), V(88), V(211), V(373)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(32), V(21), V(18), V(28), V(170)], // by relative rank 2-7 (rank 2 unreachable)
    defended_pawn_eg   = [CV(0), V(16), V(13), V(29), V(62), V(13)], // by relative rank 2-7 (rank 2 unreachable)
