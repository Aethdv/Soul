...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  60,    0),  S(   6,   28),  S(  14,   42),  S(  68,   20),
        S(  -6,   -2),  S(  16,   -2),  S(  40,   -5),  S(  60,  -21),
        S( -19,    0),  S(  16,   -9),  S(  30,  -17),  S(  58,  -24),
        S( -40,    0),  S(  -7,   -3),  S(  -6,   -5),  S(  15,  -15),
        S( -48,    0),  S( -22,   -4),  S( -36,    4),  S( -50,    4),
        S( -58,    0),  S( -20,    6),  S( -16,    5),  S( -64,    9),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-263,  -20),  S(  22,  -37),  S( -87,   11),  S( -16,   12),
        S(  -3,  -24),  S( -28,    0),  S(  67,  -21),  S(  77,    5),
        S(  -5,  -19),  S(  89,   -1),  S(  95,    3),  S( 132,    1),
        S(  57,  -33),  S(  30,   23),  S(  67,   17),  S(  77,   23),
        S(   6,   -1),  S(  31,    2),  S(  40,   22),  S(  41,   36),
        S( -54,   -2),  S(   2,    4),  S(   7,   21),  S(  27,   27),
        S( -52,  -33),  S( -45,   19),  S( -26,    6),  S( -18,   25),
        S( -99,  -42),  S( -98,  -14),  S( -57,   -6),  S( -35,    9),
    ],

    BISHOP = [
        S(-106,   29),  S( -46,   10),  S(-132,   24),  S(-127,   29),
        S( -22,    1),  S(  -8,   17),  S(   2,   12),  S( -11,   14),
        S(  23,  -11),  S(  43,    3),  S(  42,    9),  S(  83,   -7),
        S(   0,  -11),  S(  32,    8),  S(  44,   -4),  S(  72,   -7),
        S(   5,  -11),  S(  17,   -6),  S(  33,    7),  S(  48,    0),
        S(  -6,   -7),  S(  25,   -4),  S(  19,   -8),  S(  21,    3),
        S(  11,  -18),  S(  14,  -18),  S(   7,   -9),  S( -10,    3),
        S( -18,  -16),  S(  22,  -21),  S( -42,   -2),  S( -36,   -4),
    ],

    ROOK = [
        S(   7,   11),  S(  -7,   18),  S(  -1,   21),  S(   8,   13),
        S(   8,    4),  S(   3,    6),  S(  63,  -17),  S(  87,  -21),
        S(   9,   -1),  S(  56,  -11),  S(  64,  -15),  S(  95,  -30),
        S(  -6,    9),  S(  23,    0),  S(  33,   -1),  S(  41,   -6),
        S( -35,   12),  S( -19,    7),  S(  -1,    0),  S(  12,   -2),
        S( -67,    9),  S( -34,    3),  S( -32,    6),  S( -10,   -4),
        S( -90,   17),  S( -61,    0),  S( -29,  -10),  S( -20,  -12),
        S( -58,   12),  S( -33,    1),  S( -23,  -11),  S(   5,  -23),
    ],

    QUEEN = [
        S( -28,   18),  S( -32,   24),  S( -22,   29),  S( -22,   34),
        S(  -4,    6),  S( -90,   72),  S( -30,   47),  S( -40,   63),
        S(   9,   19),  S(  12,   10),  S(  -8,   50),  S(   5,   35),
        S(  34,  -29),  S( -13,   48),  S(  -3,   44),  S( -14,   52),
        S(   8,    4),  S(   8,    9),  S(  -1,   27),  S(  -3,   22),
        S(   7,  -27),  S(  33,  -35),  S(  17,  -11),  S(  23,  -11),
        S(  29,  -55),  S(  29,  -87),  S(  44,  -85),  S(  29,  -47),
        S(  17,  -65),  S(  12,  -69),  S(   0,  -58),  S(  -3,  -33),
    ],

    KING = [
        S(-185,  -94),  S(  -4,  -18),  S( -11,  -27),  S( 116,   14),
        S( -96,  -50),  S(  25,   10),  S( 119,   27),  S(  82,   35),
        S(  82,  -20),  S(  48,    9),  S(   1,   28),  S( -23,   21),
        S(  45,  -26),  S(  51,   10),  S(  -1,   18),  S( -37,   27),
        S( -21,  -11),  S( -37,   24),  S( -30,   34),  S( -23,   43),
        S( -46,   -4),  S( -54,   21),  S( -70,   36),  S( -69,   42),
        S(  40,  -30),  S(  15,   -8),  S( -35,   17),  S( -55,   20),
        S(  69,  -78),  S(  82,  -44),  S(  20,  -16),  S(  -5,  -22),
    ],
}
...
define_simd_params! {
    mobility_open {
        mg = [V(3), V(-5), V(18), V(-2)], // [mobility, battery, threats, xray threats]
        eg = [V(-6), V(-6), V(12), V(-5)],
    },
    mobility_closed {
        mg = [V(3), V(1), V(-35), V(0)],
...
define_weight_params! {
    ...
    attacker    = [CV(0), V(117), V(174), V(208), V(189), V(237)], // [0, 1, 2, 3, 4, 5] attackers × weak
    ...
    bishop_pair       = [V(64), V(55)], // [MG, EG]
    rook_open         = [V(40), V(-8)], // [MG, EG]
    minor_behind_pawn = [V(22), V(25)]; // [MG, EG]

    doubled_pawn       = [V(-25), V(-25)], // [MG, EG]
    isolated_pawn      = [V(-13), V(-10)], // [MG, EG]
    backward_pawn      = [V(-12), V(-10)], // [MG, EG]
    phalanx_mg         = [V(18), V(29), V(45), V(82), V(299), V(-34)], // by relative rank 2-7
    phalanx_eg         = [V(14), V(-1), V(6), V(42), V(24), V(498)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(52), V(35), V(46), V(78), V(269)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    defended_pawn_eg   = [CV(0), V(10), V(3), V(11), V(28), V(-8)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    passed_pawn_mg     = [V(-60), V(-47), V(-24), V(3), V(63), V(135)], // by relative rank 2-7
    passed_pawn_eg     = [V(-3), V(1), V(22), V(47), V(77), V(88)], // by relative rank 2-7
    enemy_king_dist_mg = [V(-164), V(-3), V(0), V(10), V(16), V(26)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-13), V(4), V(21), V(29), V(35), V(39)]; // enemy king→passer dist, 7 clamps to 6
}
