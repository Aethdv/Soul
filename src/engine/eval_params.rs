...
define_psqt_params! {
    ...
    PAWN = [
        ...
        S(  14,  106),  S(  51,   65),  S(  29,   96),  S(  37,   73),
        S(  15,   19),  S(  26,   21),  S(  73,  -26),  S(  52,  -49),
        S( -18,   -6),  S(  -8,  -15),  S(   3,  -33),  S(  14,  -46),
        S( -31,  -18),  S( -25,  -15),  S( -19,  -24),  S(  -2,  -28),
        S( -38,  -22),  S( -30,  -21),  S( -31,  -16),  S( -22,  -15),
        S( -35,  -15),  S( -21,  -13),  S( -20,   -9),  S( -26,   -7),
        CS(  0,    0),  CS(  0,    0),  CS(  0,    0),  CS(  0,    0),
    ],

    KNIGHT = [
        S(-143, -119),  S(-114,  -29),  S( -85,  -12),  S( -28,  -13),
        S(  18,  -30),  S(  22,    0),  S(  71,   -7),  S(  45,    1),
        S(  28,  -16),  S(  52,   -1),  S(  75,   10),  S(  93,   12),
        S(  32,   -2),  S(  16,   19),  S(  64,   28),  S(  60,   41),
        S(   0,    9),  S(  30,   13),  S(  21,   32),  S(  30,   45),
        S( -29,   -4),  S(   1,    7),  S(  -4,   10),  S(  11,   31),
        S( -24,   -5),  S( -35,    0),  S( -15,    7),  S(  -4,   11),
        S( -83,  -22),  S( -40,  -30),  S( -32,  -12),  S( -21,    5),
    ],

    BISHOP = [
        S( -47,    1),  S( -74,   16),  S( -83,    7),  S(-135,   26),
        S(   0,   -9),  S(  16,    5),  S(   9,    3),  S(  12,   -1),
        S(  26,    3),  S(  29,    1),  S(  31,    7),  S(  34,   -2),
        S(  -2,    1),  S(  10,    9),  S(  29,    6),  S(  39,   11),
        S(   4,  -12),  S(   0,    8),  S(   1,   11),  S(  25,    9),
        S(   5,   -7),  S(  13,    1),  S(   9,   10),  S(   9,   13),
        S(   8,  -20),  S(  15,  -20),  S(  24,  -20),  S(  -1,    3),
        S(  -2,  -33),  S(  21,   -1),  S(  -7,  -10),  S(  -4,   -1),
    ],

    ROOK = [
        S( -14,   12),  S( -54,   27),  S( -53,   34),  S( -69,   28),
        S(  14,    1),  S(   4,   12),  S(  23,   11),  S(  26,    2),
        S(  21,    0),  S(  57,   -5),  S(  47,   -7),  S(  48,  -11),
        S(   9,    7),  S(  22,    1),  S(  22,    3),  S(  21,   -3),
        S( -19,    9),  S(  -4,    6),  S( -14,    6),  S(  -2,    4),
        S( -16,   -6),  S(   7,  -21),  S( -10,  -13),  S( -10,   -7),
        S( -32,   -6),  S(  -9,  -16),  S(  -6,  -16),  S(  -3,  -17),
        S( -15,   -7),  S(  -3,  -14),  S( -10,   -9),  S(  12,  -23),
    ],

    QUEEN = [
        S( -11,  -74),  S( -12,  -57),  S( -32,   -6),  S( -29,    2),
        S(  46,  -26),  S( -21,   14),  S( -10,   29),  S( -40,   62),
        S(  44,   -1),  S(  47,  -16),  S(  14,   36),  S(  -1,   50),
        S(  25,   17),  S(  -1,   53),  S(  -2,   31),  S( -27,   63),
        S(   0,   28),  S(   3,   32),  S( -21,   38),  S( -17,   43),
        S(  11,  -22),  S(   1,    5),  S( -12,   18),  S( -18,   21),
        S(  27,  -64),  S(   3,  -53),  S(   8,  -39),  S(   3,  -10),
        S(  -9,  -43),  S(   5,  -47),  S(   4,  -53),  S(  13,  -22),
    ],

    KING = [
        S(  48, -123),  S(  18,  -32),  S(  31,  -23),  S( -11,  -12),
        S( -66,    7),  S(  37,   41),  S(  -1,   48),  S(  77,   24),
        S( -94,   15),  S(  73,   42),  S(  51,   54),  S(  31,   58),
        S(-129,    7),  S( -17,   37),  S( -31,   59),  S( -80,   71),
        S(-126,  -13),  S( -38,   17),  S( -36,   40),  S( -77,   62),
        S( -48,  -31),  S(  25,   -8),  S(  -9,   19),  S( -11,   32),
        S(  54,  -62),  S(  64,  -27),  S(  29,   -3),  S(   5,   10),
        S(  57, -124),  S(  81,  -78),  S(  53,  -47),  S(  62,  -55),
    ],
}
...
define_simd_params! {
    mobility_open {
        mg = [V(10), V(-4), V(4), V(2)], // [mobility, battery, threats, xray threats]
        eg = [V(-8), V(-8), V(7), V(-1)],
    },
    mobility_closed {
        mg = [V(0), V(8), V(-5), V(-6)],
        eg = [V(52), V(18), V(66), V(-45)],
    },
}
...
define_weight_params! {
    ...
    king_safety = [V(22), V(9), V(9)], // [Pawn Shield, Ortho Exp, Diag Exp]
    attacker    = [CV(0), V(148), V(252), V(438), V(524), V(541)], // [0..5] attacked king-zone squares × weak
    ...
    minor_behind_pawn = [V(11), V(31)]; // [MG, EG]

    doubled_pawn       = [V(0), V(-41)], // [MG, EG]
    isolated_pawn      = [V(-10), V(-13)], // [MG, EG]
    backward_pawn      = [V(-8), V(-17)], // [MG, EG]
    phalanx_mg         = [V(7), V(14), V(29), V(63), V(153), V(-141)], // by relative rank 2-7
    phalanx_eg         = [V(-7), V(4), V(25), V(87), V(191), V(318)], // by relative rank 2-7
    defended_pawn_mg   = [CV(0), V(30), V(19), V(18), V(32), V(245)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    defended_pawn_eg   = [CV(0), V(16), V(16), V(32), V(63), V(-13)], // by relative rank 2-7; rank 2 needs a defender on rank 1
    passed_pawn_mg     = [V(-7), V(-20), V(-23), V(0), V(-8), V(46)], // by relative rank 2-7
    passed_pawn_eg     = [V(-51), V(-28), V(20), V(72), V(162), V(147)], // by relative rank 2-7
    enemy_king_dist_mg = [V(-105), V(24), V(6), V(2), V(0), V(-4)], // enemy king→passer dist, 7 clamps to 6
    enemy_king_dist_eg = [V(-48), V(1), V(41), V(55), V(67), V(74)]; // enemy king→passer dist, 7 clamps to 6
}
